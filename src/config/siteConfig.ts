...
export const siteConfig: SiteConfig = {
  title: "Aeolira's Windlog",
  subtitle: "小舟从此逝，江海寄余生。",
  siteURL: "https://blog.040215390.xyz/", // 请替换为你的站点URL，以斜杠结尾
  siteStartDate: "2026-03-09", // 站点开始运行日期，用于站点统计组件计算运行天数
  ...
  bangumi: {
    userId: "aeolira", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
    fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
  },

  bilibili: {
    vmid: "2015110290", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
  ...
  banner: {
    ...
    src: {
      desktop: [
        "/assets/images/申鹤/申鹤1.png",
        "/assets/images/申鹤/申鹤2.png",
        "/assets/images/申鹤/申鹤3.png",
        "/assets/images/申鹤/申鹤4.png",
      ], // 桌面横幅图片
      mobile: [
        "/assets/images/申鹤/申鹤5.png",
        "/assets/images/申鹤/申鹤6.png",
        "/assets/images/申鹤/申鹤7.png",
        "/assets/images/申鹤/申鹤8.png",
      ], // 移动横幅图片
    }, // 使用本地横幅图片
